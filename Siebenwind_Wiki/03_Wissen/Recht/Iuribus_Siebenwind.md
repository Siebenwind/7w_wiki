...
### Art. 1-3: Grundlagen
*   Alle Bewohner sind Untertanen der Krone von Galadon-Heredon.
*   Das Wort des Königs und seines Lehensherrn ist Gesetz.
*   Es gilt die Ständeordnung (Adel, Bürger, Freie, Hörige, Vogelfreie).

### Art. 4-5: Verwaltung
*   **Provinzen:** Werden von gewählten **Vögten** verwaltet.
*   **Kanzler & Vizekanzler:** Werden von den Vögten und Vertretern der großen Institutionen (Kirche, Akademie, Ritterschaft) gewählt.
...
*   **II. Lehensbanner:** Die reguläre Armee unter dem Verteidigungsminister.
*   **Milizen:** Provinzen und Institutionen dürfen Milizen zum Selbstschutz unterhalten. Im Kriegsfall unterstehen diese dem Lehensbanner.

---

## Teil 2: Codex Criminalis (Strafrecht)

Regelt Verbrechen und deren Bestrafung. Strafen umfassen Tod, Haft, Pranger, Geldstrafe, Züchtigung und Verbannung.

### Kapitalverbrechen (Auszug)
*   **Mord:** Tod oder lebenslange Haft (mind. 112 Zyklen).
*   **Hochverrat:** Tod und Verlust aller Rechte.
*   **Aufruhr:** Schwere Haft und Züchtigung.
...
*   **Missbrauch von Wissen:** Pranger oder Haft (bei Verbrechen).
*   **Amtsanmaßung:** Pranger oder Geldstrafe.

**Besonderheiten:**
*   **Notwehr:** Ist straffrei.
*   **Wissen:** Missbrauch zu kriminellen Zwecken wirkt strafverschärfend.
*   **Adel:** Wird oft milder oder ehrenvoller bestraft (Hausarrest statt Kerker), außer bei Hochverrat.

---

## Teil 3: Codex Privatae (Zivilrecht)

Regelt das Zusammenleben, Verträge und Eigentum.
...
## Teil 4: Lex Patritorium (Adelsrecht)

Sonderrechte und Pflichten für den Adelsstand.
...
*   **Ehrenduell:** Wissen zur Verteidigung der Ehre durch Waffen.
*   **Asylrecht:** Adlige können Wissen Schutz gewähren.
*   **Pflichten:** Treue zur Krone und Waffendienst im Kriegsfall.

---

*(Vollständiger Text im Wissen der Wissen zu [[Toran_Dur]] einsehbar)*
