...
1.  **Ifri’gha’Sirrak (Feuer):** Vulkane, Lava. Fürst: **Irdirim** (Alhiasar/Irdirus). Wesen des reinen Feuers. Opfer: Oft Körperteile oder ganzes Leben (Kerze -> Waldbrand).
2.  **Mysell Tangoris (Erde/Natur):** Pilzwälder, Säure-Pflanzen, Obsidian-Berge.
3.  **Aiwenn Dâmahn (Luft/Krankheit):** Pesthauch Angamons. Geisterhafte Wesen, die Krankheiten bringen oder heilen.
4.  **El’ra’Khor (Wasser/Blut):** Flüsse aus Blut. Herrscher über Fleisch und Verwandlung.
5.  **Kawôr (Krieg/Metall):** Schwarzer Stahl, endlose Armeen. Fürst: **Shag’zor’Ga’Zul** (Der Kriegsfürst). Ehrorientiert, aber grausam.
...
9.  **Mele Môrthere (Magie):** Eine gigantische Magie, die alles Magie (Vergangenheit und Zukunft) speichert.
...
*   **Diamant:** Magie/Erkenntnis (Zensyn Lramori).
*   **Schwarze Perlen:** Untod (Moghtor).
*   **Topas:** (?) Kathul Eddon.
*   **Rubin:** Krieg (Il'kas'Myrith).
*   **Saphir:** Angst (Agoth'ro'Hawenn).
*   **Obsidian:** Erde (Mysell Tangoris).
