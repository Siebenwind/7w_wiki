...
### 1. Aufspüren (Methodik)
Dai beschreibt ein zweistufiges Verfahren zur Ortung:
1.  **Flux-Sicht:** Grobe Lokalisierung von Energieansammlungen.
2.  **Gitter-Sicht (Thaumaturgisches Gitter):** Detaillierte Analyse.
    *   *Warnung:* Niemals direkt *in* der Lokalität stehen, da die Energie die Wahrnehmung verzerrt.
...
### 3. Anrufung
Für die Kontaktaufnahme mit den Wächtern verweist Dai auf die Magie von **Rhadan** ("Traktate zur Ritualisierung") und **[[Aurax_Ellrothon]]** ("Batama Magica" - Edelsteine).
