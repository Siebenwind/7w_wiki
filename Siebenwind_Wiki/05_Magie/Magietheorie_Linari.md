...
Ein zentraler Teil des Werks beschreibt die Herstellung magischer Gegenstände (beispielhaft am Schwert).

### Aufbau eines Artefakts
1. **Die Klinge:** Aus edlem Erz, graviert mit **Runen**.
2. **Das Handstück:** Enthält den **Focus** und die Rune des Lebens.
3. **Der Knauf:** Besteht aus einem edlen Edelstein, der das dominante Element symbolisiert (z.B. Rubin für Feuer, Diamant für Wasser).

### Techniken
- **Tunneleffekt:** Durch die Verwendung von Reagenzien werden arkane Fäden aus anderen Sphären "angesaugt" und im Artefakt konzentriert.
- **Abraxas:** Das Aktivierungswort oder ein speziell geschliffener Edelstein, der den Effekt auslöst.

## 5. Sphärentheorie der chaotischen Ordnung
Linari postuliert, dass jede Entscheidung eine neue **Sphäre** erschafft. **Sphärenfäden** können Punkte zwischen diesen Sphären verbinden, was Phänomene wie Teleportation erklärt.

---
**Siehe auch:**
- [[Lehrbuch_Magietheorie]]
- [[Matrixtheorie_Linari]]
