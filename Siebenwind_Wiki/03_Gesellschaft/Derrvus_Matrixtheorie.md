...
# Postulat der idealen Form von Matricen
...
Die ideale Struktur einer Matrix folgt der Zahlenlehre der Alten:
* **1 (Punkt)**: Ursprung, unendliche Verdichtung, keine Ausdehnung.
* **2 (Gerade)**: Dualität, Bewegung, Verbindung zweier Punkte.
* **3 (Kreis)**: Ausgleich von Aktion und Reaktion, raumlose Grenze.
* **4-6 (Kugel)**: Drei rotierende Ur-Kreise, die den Raum erschaffen.
* **7-9 (Komplexe Praeformen)**: Astrale Ebene, in der sich die Matrizen befinden.
* **10 (Materie)**: Vollständige Erstarrung und Stofflichkeit.
