# 📥 Ingestion Report: Eigenschaften der Elemente

## Metadaten
- **Auswertungs-ID**: cd1f8eed-c838-453c-8691-43eec6acb109
- **Quelle**: Quellen/Bibliothek Toran Dur/Amanda Dunkelbaum - Eigenschaften der Elemente.md
- **Ausgewertet von**: Antigravity
- **Auswertungszeitpunkt (UTC)**: 2026-02-19T23:27:00Z
- **Workflow/Skill**: `inquisition.py` / `ingest_pipeline.py`
- **Dispatch-Referenz**: N/A
- **Quellentyp**: #überlieferung
- **Lore-Score (LQS)**: 8.4/10
...
|---|---|---|
| **A: Abdeckung** | 4 | Guter Überblick über alle fünf Grundelemente und deren magische Anwendung. |
| **T: Tiefe** | 4 | Erwähnung spezifischer Foki (Runensprüche) und praktischer Anwendungsbeispiele. |
| **K: Kanon-Konsistenz** | 5 | Konsistent mit der etablierten Magietheorie und den Elementen (Xa, Yhorn, Isaz, Hagal, Fe). |
| **B: Belegqualität** | 4 | Etablierte Autorin (Amanda Dunkelbaum) aus der Toran Dur Bibliothek. |
| **U: Unsicherheitsdisziplin** | 4 | Theoretische Abhandlung, keine offenen Gaps hinterlassen. |
| **Rohscore (0-25)** | **21** | Summe A+T+K+B+U |
| **Gesamt (LQS 0-10)** | **8.4/10** | `round(Rohscore * 10 / 25, 1)` |
...
|---|---|---|---|---|
| Amanda Dunkelbaum | UPDATE | [[Amanda_Dunkelbaum]] | 10 | Autorin des Werks. |
| Ronwo | NEU | [[Personenregister]] | 8 | Novize, Versuchsobjekt für Heilzauber. |
...
- **Highlight**: Eis verursacht ein Ungleichgewicht, aus dem indirekt "wahllos" Gifte erschaffen werden, abhängig vom Unterbewusstsein des Magiers.
- **Offene Fragen an Spezialisten**: Keine.
- **Link-Reparaturentscheidung**: N/A
