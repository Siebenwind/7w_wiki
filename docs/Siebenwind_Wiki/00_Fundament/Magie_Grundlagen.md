...
### 1. Elementarmagie
Die rohe Magie wird durch die vier **[[Die_Gohor|Ur-Elemente]]** und ihre elementaren Herrscher ([[Die_Enhor|Enhor]]) gespeist:
...
- **Höhere Magie:** Anwendung komplexer Magie ([[Die_Sprache_Run|Run]]) und theoretischer Modelle (z.B. Astralgitter).
