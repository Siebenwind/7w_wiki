...
### Ruhende Reinigung
*   **Meditation**: Klärung des Geistes und Stählung des Willens.
*   **Inniges Gebet**: Vor allem bei weißen und elementaren Pfaden zur Ausrichtung an den Mächten.
*   **Bewusster Tiefschlaf**: Langfristige geistige Regeneration (mind. 24 Stunden).
...
### Der Kreis
Der Kreis steht für absolute Neutralität und hat keine Angriffspunkte.
*   **Schutzkreis** (Links nach Rechts): Entzug schadhafter Kräfte, Hinwendung zu bauenden Kräften.
*   **Bannkreis** (Rechts nach Links): Aktives Eingreifen gegen ungewollte Mächte.
*   *Hinweis:* Ein perfekter Kreis kann nur im Arkanen (Geiste) gezogen werden, da physische Werkzeuge stets Kanten (Angriffspunkte) hinterlassen.

### Das Dreieck (Trinität)
