...
Verfasst von Magister [[Edomawyr]].

## Grundthese

Metalle haben eine natürliche Resonanz zu den Elementarkräften und können das Thaumaturgische Gitter beeinflussen. Sie wirken entweder als **Fokus** (verstärkend) oder als **Gegenfokus** (störend), abhängig von ihrer elementaren Zuordnung und Verarbeitung.

## Zuordnung der Metalle

Die Metalle entsprechen in ihrem Wesen den Elementarherren:
...
*Anmerkung: Edelsteine wie Rubine (Feuer) oder Smaragde (Erde) wirken ähnlich, oft sogar stärker als Metalle.*

## Verarbeitung und Störwirkung
...
*   **Problem:** Kaltes Verformen ist extrem schwierig und für komplexe Gegenstände wie Rüstungen kaum machbar. Zudem muss das Erz meist erst durch Hitze gewonnen werden, was die Struktur bereits beschädigt.

## Reichweite und Abschirmung

*   **Reichweite:** Der Störeffekt ("Gegenfokus") wirkt nur im direkten Kontakt oder unmittelbarer Nähe zum Körper des Magiers. Ein Krieger in Rüstung neben einem Magier stört dessen Zauber nicht.
*   **Abschirmung:** Der negative Effekt kann durch dicke Stoffe oder Leder gemindert werden. Goldmünzen in einem Lederbeutel stören weniger als solche, die direkt in der Hand gehalten werden.
