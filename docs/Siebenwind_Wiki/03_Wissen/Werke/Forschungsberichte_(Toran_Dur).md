...
Ein Protokoll über die Entwicklung des Zaubers "Visor Noctis" in zwei Varianten:
1.  Eine einfache Version zur Verstärkung des Restlichts für bessere Nachtsicht.
2.  Eine komplexe Version zur wahrnehmung der Umgebung durch die astrale Ebene (Gnosis).

### Bannung Hrasmiren
(Unterzeichnet von Hagen)
Ein detaillierter Plan zur dauerhaften Bindung des Dämons Hrasmiren in der ersten Sphäre. Der Plan involviert mehrere Phasen:
1.  Anlocken des Dämons.
2.  Schwächung durch elementare Kräfte.
...
### Niemandsrede
Fragmente von Reden der Wesenheit [[Niemand]], gerichtet an verschiedene Empfänger ([[Elfen]], seinen Schüler, Bastean). Er spricht vom "Krieg der Seelen" und dass Wissen verloren geht.
