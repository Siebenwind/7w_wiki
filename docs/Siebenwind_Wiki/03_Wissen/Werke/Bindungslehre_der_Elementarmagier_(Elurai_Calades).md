...
Verfasst von Erzmagier [[Elurai_Calades]] des Elementaren Pfades.
...
Da alle Elemente miteinander verknüpft sind, hat der Magier auch Zugriff auf die anderen Elemente ("indirekte Bindung").
*   **Stärke:** Zauber fremder Elemente sind niemals so mächtig wie die des Hauptelements.
*   **Abhängigkeit:** Stärkt der Magier die Bindung zu seinem Hauptelement, wächst auch die (geringere) Kraft in den Nebenelementen.
*   **Das Gegenelement:** Ein Rätsel bleibt, warum das direkt entgegengesetzte Element (z.B. Wasser für einen Feuermagier) oft am schwersten zu beherrschen ist und kaum an Kraft gewinnt.
