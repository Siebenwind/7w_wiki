...
2. **System-Kickoff**:
   Kopiere den Inhalt von [.agent/prompts/EXTERNAL_KICKOFF.md](file:///Users/alexandrerabe/siebenwind/7w_wiki/.agent/prompts/EXTERNAL_KICKOFF.md) in die externe CLI, um den Agenten auf das Projekt einzunorden.
...
3. **Task-Spezifizierung**:
   ...
   - **Scouting/News**: Nutze [.agent/prompts/EXTERNAL_SCOUT_TASK.md](file:///Users/alexandrerabe/siebenwind/7w_wiki/.agent/prompts/EXTERNAL_SCOUT_TASK.md).
