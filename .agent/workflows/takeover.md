---
layout: wiki_page
title: "Workflow: `/takeover` (Die Amtsübernahme)"
category: Workflow
...
2b. **Synapse-Board/Research lesen:** Öffne `/System/Synapse_Board/` und verschaffe dir einen Überblick über alle Tickets (`NEEDS_REVIEW`) sowie das [[System/Synapse_Board/LORE_RESEARCH_BOARD.md|Lore Research Board]] (aktive Historian-Faelle + Themenreservoir).
2c. **Claiming:** Entscheide, ob ein echter Historian-Fall anliegt oder ob der Vorgang operativ loesbar ist; claime nur aktive Historian-Faelle.
// turbo
